...
begin
	...
	begin
		...
		select customer_id,customer_name,branch_id,customer_type,
		customer_type_explanation,national_code,src.job,phone
		from src.customer join src.customer_type 
		...
		insert into  dimention_customer(customer_id,customer_name,branch_id,
		customer_type,customer_type_explanation,national_code,src.job,phone,start_date,curr_flag)
		select customer_id,customer_name,branch_id,customer_type,
		customer_type_explanation,national_code,src.job,phone,GETDATE(),1
		from temp_new_jobs
	...
	begin
		...
		customer_type,customer_type_explanation,national_code,src.job,phone,start_date,curr_flag)
		select customer_id,customer_name,branch_id,customer_type,
		customer_type_explanation,national_code,src.job,phone,'14000101',1
