...
statment : TOKEN_ID TOKEN_ASSIGNOP expr TOKEN_SEMICOLON  //*=  SCALAR VARS
		{
			...
			if(scalar_symbol->symbol_type != ($3)->expr_type){
...
method_call : TOKEN_ID TOKEN_LP call_params TOKEN_RP
		{
			...
			if(func->num_args != ($3)->num_args) yyerror("Error: number of used arguments does not match with defined function.\nfunction should have *"+ convertToString(func->num_args)+" arguments*.\n");
...
optional_else: TOKEN_ELSECONDITION block | /* empty */ ;
