...
_0x0:
	.DB  0xD,0xA,0x20,0x79,0x65,0x73,0x20,0xD
	.DB  0xA,0x0,0xD,0xA,0x20,0x6E,0x6F,0x20
	.DB  0x6D,0x61,0x74,0x63,0x68,0x20,0x77,0x69
	.DB  0x74,0x68,0x20,0x79,0x20,0xD,0xA,0x0
	.DB  0x74,0x78,0x3A,0x20,0x70,0x6F,0x6C,0x6C
	.DB  0x69,0x6E,0x67,0x20,0xD,0xA,0x20,0x72
	.DB  0x78,0x20,0x69,0x6E,0x74,0x65,0x72,0x72
	.DB  0x75,0x70,0x74,0x0
...
; 0000 003C data=UDR;
	IN   R16,12
; 0000 003D if(data == 'y') printf("\r\n yes \r\n");
	CPI  R16,121
	BRNE _0x3
	__POINTW1FN _0x0,0
	RJMP _0xD
; 0000 003E else printf("\r\n no match with y \r\n");
_0x3:
	__POINTW1FN _0x0,10
_0xD:
	ST   -Y,R31
...
; 0000 00AC // USART Receiver: On
; 0000 00AD // USART Transmitter: On
; 0000 00AE // USART Mode: Asynchronous
; 0000 00AF // USART Baud Rate: 9600
; 0000 00B0 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 00B1 UCSRB=(1<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(152)
	OUT  0xA,R30
; 0000 00B2 UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 00B3 UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 00B4 UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 00B5 
...
; 0000 00C9 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 00CA 
; 0000 00CB // Global enable interrupts
; 0000 00CC #asm("sei")
	sei
; 0000 00CD 
; 0000 00CE printf("tx: polling \r\n rx interrupt");
	__POINTW1FN _0x0,32
	ST   -Y,R31
	ST   -Y,R30
	LDI  R24,0
