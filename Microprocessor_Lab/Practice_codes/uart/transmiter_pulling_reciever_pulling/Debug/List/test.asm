...
; 0000 0073 // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 0074 // USART Receiver: On
; 0000 0075 // USART Transmitter: On
; 0000 0076 // USART Mode: Asynchronous
; 0000 0077 // USART Baud Rate: 9600
; 0000 0078 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0079 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
; 0000 007A UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
; 0000 007B UBRRH=0x00;
	LDI  R30,LOW(0)
	OUT  0x20,R30
; 0000 007C UBRRL=0x33;
	LDI  R30,LOW(51)
	OUT  0x9,R30
; 0000 007D 
