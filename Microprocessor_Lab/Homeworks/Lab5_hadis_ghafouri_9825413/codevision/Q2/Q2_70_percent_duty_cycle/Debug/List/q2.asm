...
; 0000 0034 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 0035 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
; 0000 0036 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 0047 // Clock value: 1000.000 kHz
; 0000 0048 // Mode: Phase correct PWM top=0xFF
; 0000 0049 // OC0 output: Non-Inverted PWM
; 0000 004A // Timer Period: 0.51 ms
; 0000 004B // Output Pulse(s):
; 0000 004C // OC0 Period: 0.51 ms Width: 0.356 ms
; 0000 004D TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (0<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(98)
	OUT  0x33,R30
