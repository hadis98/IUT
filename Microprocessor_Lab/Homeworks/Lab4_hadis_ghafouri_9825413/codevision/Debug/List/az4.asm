...
_0x20000:
	.DB  0x53,0x65,0x73,0x73,0x69,0x6F,0x6E,0x34
	.DB  0xA,0x0
_0x40003:
	.DB  0xE8,0x3
_0x40005:
	.DB  LOW(_0x40004),HIGH(_0x40004)
_0x40007:
	.DB  LOW(_0x40006),HIGH(_0x40006)
_0x40009:
	.DB  LOW(_0x40008),HIGH(_0x40008)
_0x40000:
	.DB  0x30,0x30,0x3A,0x30,0x30,0x3A,0x30,0x30
	.DB  0x3A,0x30,0x30,0x0,0x43,0x45,0x3A,0x30
	.DB  0x30,0x30,0x30,0x0,0x30,0x30,0x30,0x30
	.DB  0x30,0x30,0x30,0x0,0x43,0x45,0x3A,0x46
	.DB  0x55,0x4C,0x4C,0x2A,0x2A,0x0,0x43,0x45
	.DB  0x3A,0x25,0x34,0x64,0x2A,0x2A,0x0,0x25
	.DB  0x32,0x64,0x3A,0x25,0x32,0x64,0x3A,0x25
	.DB  0x32,0x64,0x3A,0x25,0x32,0x64,0x0,0x53
	.DB  0x65,0x73,0x73,0x69,0x6F,0x6E,0x34,0xA
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0001 0005     init_ports_config();
	RCALL _init_ports_config
; 0001 0006     init_interrupts_config();
	RCALL _init_interrupts_config
; 0001 0007     init_timers_config();
	RCALL _init_timers_config
; 0001 0008     init_lcd_config();
	RCALL _init_lcd_config
; 0001 0009 }
	RET
; .FEND
;
...
; 0002 001C     parking_capacity_handler();
	RCALL _parking_capacity_handler
; 0002 001D }
	RJMP _0x40029
; .FEND
;
...
; 0002 004A     if (car_in_button_port == is_button_clicked && parking_empty_capacity > 0)
	SBIC 0x16,7
	RJMP _0x4000B
	LDS  R26,_parking_empty_capacity
	LDS  R27,_parking_empty_capacity+1
	CALL __CPW02
	BRLT _0x4000C
_0x4000B:
	RJMP _0x4000A
...
; 0002 004C         parking_empty_capacity--;
	LDI  R26,LOW(_parking_empty_capacity)
	LDI  R27,HIGH(_parking_empty_capacity)
	LD   R30,X+
	LD   R31,X+
	SBIW R30,1
	RJMP _0x40027
...
_0x4000E:
	LDS  R30,_parking_empty_capacity
	LDS  R31,_parking_empty_capacity+1
	SBIW R30,0
	BRNE _0x40011
; 0002 0054     {
...
; 0002 005D     lcd_puts(LCD_CAR_CAPACITY_OUTPUT);
	LDS  R26,_LCD_CAR_CAPACITY_OUTPUT
	LDS  R27,_LCD_CAR_CAPACITY_OUTPUT+1
	RJMP _0x2080003
; 0002 005E }
; .FEND
;
...
; 0002 0084         timer_calculate_digits_handler();
	RCALL _timer_calculate_digits_handler
; 0002 0085     }
; 0002 0086 
; 0002 0087     sprintf(LCD_TIMER_OUTPUT, "%2d:%2d:%2d:%2d", hour, minute, second, hundredth_of_second);
_0x4001A:
	LDS  R30,_LCD_TIMER_OUTPUT
	LDS  R31,_LCD_TIMER_OUTPUT+1
	ST   -Y,R31
	ST   -Y,R30
...
; 0002 0089     lcd_puts(LCD_TIMER_OUTPUT);
	LDS  R26,_LCD_TIMER_OUTPUT
	LDS  R27,_LCD_TIMER_OUTPUT+1
	RJMP _0x2080003
; 0002 008A }
; .FEND
;
...
SUBOPT_0x2:
	LDS  R30,_LCD_CAR_CAPACITY_OUTPUT
	LDS  R31,_LCD_CAR_CAPACITY_OUTPUT+1
	ST   -Y,R31
	ST   -Y,R30
	RET
